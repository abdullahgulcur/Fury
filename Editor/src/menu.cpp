...
namespace Editor {
	...
	//		if (Menu::mouseDistanceControl()) {

	//			if (fileSystemControlVars.temp_lastClickedItem->type == FileType::folder) {

	//				fileSystemControlVars.lastClickedItem = fileSystemControlVars.temp_lastClickedItem;
	//				fileSystemControlVars.subfolderCheckFlag = false;
	//			}
	//			else
	//				ShellExecute(NULL, L"open", std::filesystem::absolute(fileSystemControlVars.temp_lastClickedItem->path).c_str(), NULL, NULL, SW_RESTORE);
	//		}
	//	}
	...
	//		if (Menu::mouseDistanceControl() && !fileSystemControlVars.toggleClicked && !fileSystemControlVars.panelRightItemClicked)
	//			fileSystemControlVars.lastClickedItem = fileSystemControlVars.temp_lastClickedItem;
	...
	//			fileSystemControlVars.lastSelectedItem = NULL;
	//	}
	...
	//		if (!fileSystemControlVars.inspectorHovered || !fileSystemControlVars.panelRightItemClicked) // !fileSystemControlVars.panelRightItemTab && 
	//			fileSystemControlVars.lastSelectedItem = NULL;
	...
	//			if (fileSystemControlVars.lastSelectedItem != NULL)
	//				fileSystemControlVars.lastSelectedItem = Core::instance->fileSystem->duplicateFile(fileSystemControlVars.lastSelectedItem);
	//		}

	//		if (ImGui::IsKeyPressed('S')) {

	//			Core::instance->saveLoadSystem->saveEntities(core);
	//		}
	...
	//			Core::instance->fileSystem->deleteFileCompletely(fileSystemControlVars.lastSelectedItem);
	//			fileSystemControlVars.lastSelectedItem = NULL;
	//		}
	//	}
	...
	//		if (fileSystemControlVars.lastSelectedItem != NULL && fileSystemControlVars.renameItem == NULL) {

	//			if (fileSystemControlVars.lastSelectedItem->type == FileType::folder)
	//				fileSystemControlVars.lastClickedItem = fileSystemControlVars.lastSelectedItem;
	//			else
	//				ShellExecute(NULL, L"open", std::filesystem::absolute(fileSystemControlVars.lastSelectedItem->path).c_str(), NULL, NULL, SW_RESTORE);
	//		}

	//		if (fileSystemControlVars.renameItem != NULL)
	//			fileSystemControlVars.renameItem = NULL;
	//	}
