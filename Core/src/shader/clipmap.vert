...
layout (location = 3) in float scale_instance;
layout (location = 4) in float texSize_instance;
layout (location = 5) in float level_instance;
layout (location = 6) in mat4 model_instance;
