...
{ 
    float height =  texture(texture5, texCoords).r;     
...
//    float currentDepthMapValue = texture(texture5, currentTexCoords).r;
//      
...
//        currentDepthMapValue = texture(texture5, currentTexCoords).r;  
...
//    float beforeDepth = texture(texture5, prevTexCoords).r - currentLayerDepth + layerDepth;
// 
...
void main(){
    ...
    // gamma correct
    color = pow(color, vec3(1.0/2.2));// * ao; 
