...
namespace Fury {
	...
	GlobalVolume::GlobalVolume() {
		...
		GlobalVolume::createCubeVAO();
		GlobalVolume::createQuadVAO();
	...
	void GlobalVolume::createCubeVAO() {
	...
	void GlobalVolume::createQuadVAO()
	{
		GlewContext* glew = Core::instance->glewContext;
